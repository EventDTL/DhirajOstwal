        ...
        <>
            <nav className={styles.container}>
                <div className={styles.first}>
                    <Image src="/images/BS.png" alt="Logo" width={200} height={100} priority
                        ...
                        <ul className="nav">
                            ...
                            <li className="nav-item">
                                ...
                                >
                                    ...
                                    <MenuItem onClick={handleServicesClose}>
                                        <Link href="/services/comforReg" className={styles.menudata}>Company Formation and Registration</Link>
                                    </MenuItem>
                                    <MenuItem onClick={handleServicesClose}>
