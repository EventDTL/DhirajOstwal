...
export const generateMetadata = () => {
    return {
      title: "NPO Services | Expert CA Firm Support for Non-Profit Organizations",
      description:
        "Comprehensive services for Non-Profit Organizations (NPOs) by our CA firm. We offer guidance on registration, compliance, and financial management to help your NPO achieve its mission effectively.",
      keywords: [
        "npo",
        "npo questions",
        "legal services",
      ...
      canonical: "https://www.cadhirajostwal.com/services/comforReg/NonProf",
    };
  };
  ...
  <Link href={"/services/comforReg/Association"}>
    <h2>Society and Associations</h2>
        ...
        <img src="/images/istockphoto-486772894-612x612.jpg" alt="NPO Guide" />
          ...
          <h2>Legal Framework for NPOs in India</h2>
          <p>
          ...
          <div className={styles.unordered1}>
            <ul>
              ...
              <li><a href="https://www.cadhirajostwal.com/services/auditservices/Statutory">Statutory</a> audits (depending on income thresholds)</li>
            </ul>
          </div>
          <p>
          ...
          <h2>NPO Operations and Management</h2>
          ...
          <h2>NPOs in Specific Sectors</h2>
          ...
          <h2>Setting Up an NGO: Step-by-Step Guide</h2>
          ...
          <h2>Challenges and Opportunities for NPOs</h2>
          <p>
          ...
          <h2>The Future of Non-Profits in India</h2>
          <p>
