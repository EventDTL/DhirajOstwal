...
export const generateMetadata = () => {
  return {
    ...
    canonical:
      "https://www.cadhirajostwal.com/services/drafting_agreements/PartDeed",
  };
};
        ...
        <div className={styles.links}>
          ...
          <div className={styles.blog}>
            ...
            <p>
              ...
              good starting point, it's important to customize them to fit your
            ...
            <div className={styles.unordered1}>
              ...
              <p>
                ...
                India, it's highly recommended for legal protection and
                credibility. The partnership firm registration process typically
                involves:
              </p>
              <div className={styles.unordered1}>
                <ul>
                  <li><a href="https://www.cadhirajostwal.com/services/drafting_agreements/Drafting">Drafting</a> the partnership deed</li>
                ...
                <p>
                  ...
                  weeks, with costs depending on the state and the firm's
                  capital.
                </p>
              </div>
              ...
              <div className={styles.unordered1}>
                <ul>
                  <li>Ability to sue third parties in the firm's name</li>
            ...
            <div className={styles.unordered1}>
              <ul>
                <li>
                  Outline each partner's specific duties and areas of
                  responsibility
                </li>
            ...
            <div className={styles.unordered1}>
              <ul>
                <li>Clear definition of each partner's role</li>
